...
public class GL3DCone extends GL3DMesh {
    ...
    public GL3DCone(double radius, double height, int detail, GL3DVec4d color) {
        this("Cone", radius, height, detail, color);
    }

    public GL3DCone(String name, double radius, double height, int detail, GL3DVec4d color) {
