...
public class GL3DArrow extends GL3DGroup {
    ...
    public GL3DArrow(double radius, double offset, double length, int detail, Vector4d color) {
        this("Arrow", radius, offset, length, detail, color);
    }
   
    public GL3DArrow(String name, double radius, double offset, double length, int detail, Vector4d color) {
        super(name);
