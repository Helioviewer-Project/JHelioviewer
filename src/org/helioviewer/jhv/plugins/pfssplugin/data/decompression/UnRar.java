...
class UnRar
{
	 ...
	 * @throws IOException
	 *             The jUnrar library seems unable to decompress a
	 *             byteArrayInputStream and needs to have a file on the local
	 *             filesystem. Throws an IOException if it was unable to write
	 *             the temp file.
	 */
