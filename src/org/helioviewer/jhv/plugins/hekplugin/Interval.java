...
public class Interval<TimeFormat extends Comparable<TimeFormat>> implements IntervalComparison<TimeFormat>
{
	...
	{
		return (this.containsPointInclusive(other.start) || this.containsPointInclusive(other.end))
				|| (other.containsPointInclusive(this.start) || other.containsPointInclusive(this.end));
	}
	 ...
	 * <li><code>this.exclude(other).get(i).overlaps(other) == false</code></li>
	 * <li><code>this.exclude(other).get(i).containsPoint(x) == true</code> for
	 * all x with
	 * <code> this.containsPoint(x) && ! other.containsPoint(x) </code></li>
	 * 
	 ...
	 * <li>that start is before or equal to end (using the compareTo method)
	 * </li>
	 * 
