 ...
 * @author Malte Nuhn
 */
public class NewTableSelectionModel extends DefaultListSelectionModel implements LayersListener {

    private static final long serialVersionUID = 2276237017135257828L;

    /** The sole instance of this class. */
    private static final NewTableSelectionModel SINGLETON = new NewTableSelectionModel();
     ...
     * */
    public static NewTableSelectionModel getSingletonInstance() {
        return SINGLETON;
    }
     ...
     * Default constructor
     */
    private NewTableSelectionModel() {
        this.setSelectionMode(NewTableSelectionModel.SINGLE_SELECTION);
