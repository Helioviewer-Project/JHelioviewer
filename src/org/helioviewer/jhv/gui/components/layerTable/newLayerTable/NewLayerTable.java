 ...
 */
public class NewLayerTable extends JTable {
    private static final long serialVersionUID = 1L;

    public static final int ROW_HEIGHT = 25;

    public NewLayerTable() {
        super(NewLayerTableModel.getSingletonInstance());
        this.setSelectionModel(NewTableSelectionModel.getSingletonInstance());
        ...
        this.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
            	GuiState3DWCS.layers.setActiveLayer(getSelectedRow());
                ...
                if (col == NewLayerTableModel.COLUMN_VISIBILITY) {

                    layersModel.setVisibleLink(row, !layersModel.isVisible(index));

                } else if (col == NewLayerTableModel.COLUMN_BUTTON_REMOVE) {
    ...
    private void setupColumns() {
        ...
        descriptorIconRenderer.setFixedWidth(this, NewLayerTableModel.COLUMN_VISIBILITY);
        getColumnModel().getColumn(NewLayerTableModel.COLUMN_VISIBILITY).setCellRenderer(descriptorIconRenderer);
        getColumnModel().getColumn(NewLayerTableModel.COLUMN_TITLE).setCellRenderer(new DescriptorTitleRenderer(true));
        getColumnModel().getColumn(NewLayerTableModel.COLUMN_TITLE).setPreferredWidth(35);
        getColumnModel().getColumn(NewLayerTableModel.COLUMN_TITLE).setWidth(35);
        
        getColumnModel().getColumn(NewLayerTableModel.COLUMN_TIMESTAMP).setCellRenderer(new DescriptorTimestampRenderer(true));
        getColumnModel().getColumn(NewLayerTableModel.COLUMN_TIMESTAMP).setPreferredWidth(15);
        ...
        iconRenderer.setFixedWidth(this, NewLayerTableModel.COLUMN_BUTTON_REMOVE);
        getColumnModel().getColumn(NewLayerTableModel.COLUMN_BUTTON_REMOVE).setCellRenderer(iconRenderer);
    }
}