...
public class IconBank {
    ...
    public static enum JHVIcon {
        ...
        NEW_ZOOM_IN("zoom_in_128x128.png"), NEW_ZOOM_OUT("zoom_out_128x128.png"), NEW_ZOOM_1TO1("zoom_1_to_1_128x128.png"),
        NEW_ZOOM_FIT("zoom_fit_128x128.png"), NEW_ZOOMBOX("zoombox_128x128.png"),
        ...
        VISIBLE("visible_128x128.png"), HIDDEN("invisible_128x128.png"),
        ...
        FULLSCREEN("fullscreen_128x128.png"), SETTINGS("settings_128x128.png"),
        
        CAMERA_MODE_3D("sphere_128x128.png"), CAMERA_MODE_2D("circle_128x128.png"),
        NEW_TRACK("track_128x128.png"),
        NEW_ROTATION("Rotation_128x128.png"), NEW_ROTATION_Y_AXIS("Rotation_Y_Axis_128x128.png"),
        // LAYER ICONS
